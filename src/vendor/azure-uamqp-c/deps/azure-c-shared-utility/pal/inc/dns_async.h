...
#include "azure_c_shared_utility/umock_c_prod.h"
    ...
    */
    ...
    /**
    * @brief    Return the IPv6 of a completed lookup process. Call only after dns_async_is_lookup_complete indicates completion.
    *
    * @param   dns    The DNS_ASYNC_HANDLE.
    *
    * @return    @c A unsigned char* IPv6 address. NULL indicates failure or not finished.
    */
    MOCKABLE_FUNCTION(, unsigned char*, dns_async_get_ipv6, DNS_ASYNC_HANDLE, dns);
